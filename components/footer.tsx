        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <span className="text-3xl font-bold text-white">DELEX</span>
              <span className="text-sm text-gray-400">LLC</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400">(302) 507-2525</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400">info@delexllc.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400">Wilmington, DE & Cinnaminson, NJ</p>
              </div>
            </div>
          </div>
        </div>

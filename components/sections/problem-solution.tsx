        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
          ...
          >
            <div className="inline-block mb-3 sm:mb-4">
              <span className="px-3 py-1.5 sm:px-4 sm:py-2 bg-red-100 text-red-700 rounded-full text-xs sm:text-sm font-semibold">
                Common Challenges
              </span>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              {benefits.map((benefit, index) => (
                <motion.div
                  ...
                  className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow"
                >
                  <div className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center">
                    <svg
                  ...
                  <p className="text-sm sm:text-base md:text-lg text-gray-800 font-medium">{benefit}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>

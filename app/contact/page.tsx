...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen pt-16">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@delexllc.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(302) 507-2525</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">New Jersey to Florida</p>
                    <p className="text-gray-600">All East Coast States</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Optional: Service Area Map/Visual */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Serving the entire East Coast from New Jersey to Florida
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-gray-600">Primary hub and operations center</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">East Coast Corridor</h3>
              <p className="text-gray-600">Complete I-95 coverage, all states</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Florida</h3>
              <p className="text-gray-600">Dedicated service to all Florida regions</p>
            </motion.div>
          </div>
        </div>
      </div>
